...
- ✅ **Roteamento dinâmico** via fluxos APIFY
...
export APIFY_AUTHORIZATION_SPAN_MODE="prefix"  # none, hidden, prefix, suffix, all
```
...
export APIFY_AUTHORIZATION_SPAN_MODE="none"

# Mostrar mascarado
export APIFY_AUTHORIZATION_SPAN_MODE="hidden"  # "xxxxxxxxxx"

# Mostrar prefixo
export APIFY_AUTHORIZATION_SPAN_MODE="prefix"  # "Bearer eyJhbG..."

# Mostrar sufixo
export APIFY_AUTHORIZATION_SPAN_MODE="suffix"  # "...xyz123"

# Mostrar completo
export APIFY_AUTHORIZATION_SPAN_MODE="all"     # "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
```
