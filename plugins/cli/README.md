...
The CLI module provides a complete command-line interface for APIFY applications, allowing declarative definition, parsing and validation of arguments through YAML configuration.
...
**License**: MIT  
**Repository**: https://github.com/apifyhost/apify
