...
O módulo Log fornece funcionalidades de logging estruturado para aplicações APIFY, permitindo registrar mensagens com diferentes níveis de severidade.
...
- ✅ **Configuração flexível**: Via variável de ambiente APIFY_LOG
...
```bash
# Nível de log padrão
export APIFY_LOG="debug"  # info, debug, warn, error
```
...
```bash
# Apenas erros
export APIFY_LOG="error"

# Warnings e erros
export APIFY_LOG="warn"

# Informações, warnings e erros
export APIFY_LOG="info"

# Todos os logs incluindo debug
export APIFY_LOG="debug"
```
...
```
[2024-01-01T00:00:00Z INFO  APIFY] Aplicação iniciada com sucesso
[2024-01-01T00:00:01Z DEBUG APIFY] Variável x = 42
[2024-01-01T00:00:02Z WARN  APIFY] Configuração não encontrada, usando padrão
[2024-01-01T00:00:03Z ERROR APIFY] Falha na conexão com banco de dados
```
...
**Licença**: MIT  
**Repositório**: https://github.com/apifyhost/apify
