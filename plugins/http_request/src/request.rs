    ...
    fn from(error: Error) -> Self {
        match error {
            ...
            Error::ValueError(e) => format!(
                "Value error: {}",
                match e {
                    sdk::valu3::Error::NonParsebleMsg(msg) => msg,
                    sdk::valu3::Error::NonParseble => "Non parseable".to_string(),
                    sdk::valu3::Error::NotNumber => "Not a number".to_string(),
                }
            )
            .to_value(),
        }
